...
import { buscarTotaisPeriodo, buscarRankingPorSetor, buscarDesperdicioPorSemana } from './indicadoresApi'
...
export default function IndicadoresPage() {
  ...
  useEffect(() => {
    ...
    setCarregando(true)
    setErro(null)
    Promise.all([buscarTotaisPeriodo(inicio, fim), buscarRankingPorSetor(inicio, fim), buscarDesperdicioPorSemana(8)])
      .then(([totaisRes, rankingRes, semanasRes]) => {
        setTotais(totaisRes)
